...
public:
    ...
    void setupUi(QWidget *iotstockview_base)
    {
        ...
        iotstockview_base->resize(637, 528);
        ...
        iotstockview_base->setMinimumSize(QSize(320, 240));
        ...
        chViewProductsListAsTable->setMinimumSize(QSize(0, 0));
        ...
        chViewProductsListAsGrid->setMinimumSize(QSize(0, 0));
        chViewProductsListAsGrid->setBaseSize(QSize(0, 0));
        ...
        spacerItem = new QSpacerItem(40, 10, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        horizontalLayout_17->addWidget(errLabel);


        vboxLayout1->addLayout(horizontalLayout_17);
...
"color:black;"));
        ...
        groupFilterOffers->setGeometry(QRect(10, 20, 501, 126));
        ...
        rbProductsFilterBySubCategory->setGeometry(QRect(-90, 0, 234, 18));
        ...
        groupFilterProducts->setGeometry(QRect(20, 140, 501, 171));
        ...
        rbProductsFilterByDesc->setChecked(true);
        ...
        gridLayout_3->addWidget(rbProductsFilterByMostSold, 3, 0, 1, 1);
        ...
        gridLayout_3->addWidget(rbProductsFilterByLessSold, 4, 0, 1, 1);
        ...
        gridLayout_3->addWidget(rbProductsFilterByAlmostSoldOut, 5, 0, 1, 1);
        ...
        gridLayout_3->addWidget(rbProductsFilterByNotAvailable, 3, 1, 1, 1);
        ...
        gridLayout_3->addWidget(rbProductsFilterByGroup, 4, 1, 1, 1);
        ...
        gridLayout_3->addWidget(rbProductsFilterByRaw, 5, 1, 1, 1);

        groupSOFilter = new QGroupBox(pageFilters1);
        groupSOFilter->setObjectName(QString::fromUtf8("groupSOFilter"));
        groupSOFilter->setGeometry(QRect(10, 320, 521, 197));
