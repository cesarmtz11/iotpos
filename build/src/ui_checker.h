...
public:
    ...
    void setupUi(QWidget *priceChecker)
    {
        ...
        priceChecker->setMinimumSize(QSize(460, 300));
        priceChecker->setMaximumSize(QSize(460, 346));
        ...
        font.setBold(true);
        font.setWeight(75);
        labelPCTotal->setFont(font);
        labelPCTotal->setScaledContents(true);
        ...
        labelPhoto->setAlignment(Qt::AlignHCenter|Qt::AlignTop);
        ...
        editCode->setMinimumSize(QSize(0, 0));
